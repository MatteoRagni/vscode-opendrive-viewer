/*
 * Copyright 2024 Sebastian Pagel
 *   https://odrviewer.io
 *   https://github.com/pageldev/libOpenDRIVE/tree/e676a8dbfa6328fa81eafcfd93f14dfb1010fee9
 * 
 * Modified by Matteo Ragni under the same license.
 * 
 ...
 * 
 * MODIFICATIONS FROM ORIGINAL FILES:
 * 
 *  - load wasm binaries from a local variable
 *  - removed load for default opendrive
 *  - removed default opendrive
 *  - Clear color is now a different color (#212529)
 *  - some minor modifications (like removed exports)
 */
var OdrViewer = (() => {
  ...
  return (
    function (OdrViewer) {
      ...
      var Module = typeof OdrViewer != "undefined" ? OdrViewer : {};
      ...
      if (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER) { // FIXME: DUPLICATE UP WITH ELSE
      ...
      function createWasm() {
        ...
        function receiveInstance(instance, module) {
          ...
          Module["asm"] = exports;
          wasmMemory = Module["asm"]["ub"];
          updateGlobalBufferAndViews(wasmMemory.buffer);
          wasmTable = Module["asm"]["wb"];
          addOnInit(Module["asm"]["vb"]);
      ...
      var ASM_CONSTS = {
        475712: $0 => {
          window.open(UTF8ToString($0), "_self")
        }
      };
      ...
      function _glClearColor(x0, x1, x2, x3) {
        ...
        // This forces to have the background of the same color of the background of the page
        GLctx["clearColor"](0.1294, 0.1451, 0.1608, 1.0)
      }
      ...
      var asmLibraryArg = {
        ...
        "rb": _emscripten_get_device_pixel_ratio,
        "ua": _emscripten_get_element_css_size,
        ...
        "Ma": _emscripten_webgl_enable_OES_vertex_array_object,
        "B": _emscripten_webgl_enable_extension,
        "Oa": _emscripten_webgl_get_current_context,
        "fb": _environ_get,
        ...
        "aa": _glActiveTexture,
        "r": _glAttachShader,
        "p": _glBindAttribLocation,
        "b": _glBindBuffer,
        "w": _glBindFramebuffer,
        "q": _glBindTexture,
        "i": _glBindVertexArray,
        "N": _glBindVertexArrayOES,
        "Ra": _glBlendEquation,
        ...
        "Aa": _glFramebufferTexture2D,
        "m": _glGenBuffers,
        "Ba": _glGenFramebuffers,
        "X": _glGenTextures,
        "T": _glGenVertexArrays,
        ...
        "W": _glTexParameteri,
        "Qa": _glUniform1i,
        "C": _glUniformMatrix4fv,
        "x": _glUseProgram,
        "g": _glVertexAttribPointer,
        "Y": _glViewport,
        "n": _glfwCreateStandardCursor,
        "Ia": _glfwCreateWindow,
        "Xa": _glfwGetClipboardString,
        "H": _glfwGetCursorPos,
        "ob": _glfwGetFramebufferSize,
        "ab": _glfwGetInputMode,
        "_a": _glfwGetJoystickAxes,
        "Za": _glfwGetJoystickButtons,
        "A": _glfwGetMouseButton,
        "ib": _glfwGetTime,
        "na": _glfwGetWindowSize,
        "La": _glfwInit,
        "Ha": _glfwMakeContextCurrent,
        "ra": _glfwPollEvents,
        "Ea": _glfwSetCharCallback,
        "Ya": _glfwSetClipboardString,
        "$a": _glfwSetCursor,
        "Va": _glfwSetCursorEnterCallback,
        "bb": _glfwSetCursorPos,
        "Ca": _glfwSetCursorPosCallback,
        "oa": _glfwSetErrorCallback,
        "ea": _glfwSetInputMode,
        "Na": _glfwSetKeyCallback,
        "va": _glfwSetMonitorCallback,
        "_": _glfwSetMouseButtonCallback,
        "M": _glfwSetScrollCallback,
        "Wa": _glfwSetWindowFocusCallback,
        "sa": _glfwSetWindowSize,
        "Da": _glfwSetWindowSizeCallback,
        "xa": _glfwSwapInterval,
        "Fa": _glfwTerminate,
        "v": _glfwWindowHint,
        "eb": _strftime_l
      };
      ...
      var ___cxa_is_pointer_type = Module["___cxa_is_pointer_type"] = function () {
        return (___cxa_is_pointer_type = Module["___cxa_is_pointer_type"] = Module["asm"]["Cb"]).apply(null, arguments)
      };
